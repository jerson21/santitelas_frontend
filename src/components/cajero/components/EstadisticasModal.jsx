        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <StatCard
              ...
              value={`$${formatCurrency(calcularBruto(estadisticas.dia_actual.monto_total))}`}
              subtitle={`Neto: $${formatCurrency(estadisticas.dia_actual.monto_total)}`}
              icon={DollarSign}
              color="green"
            />
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <StatCard
              ...
              value={`$${formatCurrency(calcularBruto(estadisticas.pendientes_historicos.monto_total))}`}
              subtitle={`Neto: $${formatCurrency(estadisticas.pendientes_historicos.monto_total)}`}
              icon={DollarSign}
              color="orange"
            />
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <div className="text-right">
                    <div className="font-semibold text-orange-600">
                      ${formatCurrency(calcularBruto(estadisticas.pendientes_historicos.monto_total))}
                    </div>
                    <div className="text-xs text-gray-500">
                      Neto: ${formatCurrency(estadisticas.pendientes_historicos.monto_total)}
                    </div>
                  </div>
                </div>
                <div className="flex justify-between items-center py-2">
